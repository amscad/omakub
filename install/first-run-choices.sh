OPTIONAL_APPS=("Brave" "Spotify" "Zed" "VirtualBox" "RubyMine")
DEFAULT_OPTIONAL_APPS='Brave,Spotify,Zed,VirtualBox','RubyMine'
...
SELECTED_LANGUAGES="Ruby on Rails","Node.js,Go,Python"
